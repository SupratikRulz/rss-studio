...
import useTodayTab from "@/hooks/pages/today/use-today-tab";
...
export default function TodayPageContent() {
  ...
  const { activeTab, setActiveTab, todayFeedItems, todayExploreItems } =
    useTodayTab(router, searchParams, feedItems, exploreFeedItems);
